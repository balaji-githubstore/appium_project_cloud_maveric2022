...
public class Demo4TouchActionScroll2NativeApp {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		//wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy.xpath("label == 'YOUR CART")));
		...
		action.press(PointOption.point(364, 503))
		.waitAction(WaitOptions.waitOptions(Duration.ofMillis(600)))
		.moveTo(PointOption.point(363, 414))
		.release()
		.perform();
